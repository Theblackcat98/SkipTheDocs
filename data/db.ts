...
export const DB_CONFIGS: ConfigFile[] = [
  {
    ...
    filePath: './data/configs/nvim-lua-kickstart.lua',
  },
  {
    id: 'tmux-basic-2024',
    tool: 'Tmux',
    ...
    filePath: './data/configs/tmux-basic.conf',
  },
  {
    id: 'zsh-simple',
    tool: 'Zsh',
    ...
    filePath: './data/configs/zsh-simple.zshrc',
  },
  {
    ...
    filePath: './data/configs/alacritty-tokyonight.toml',
  },
  {
    id: 'kitty-dracula',
    tool: 'Kitty',
    ...
    filePath: './data/configs/kitty-dracula.conf',
  },
  {
    id: 'fish-basic',
    tool: 'Fish',
    ...
    filePath: './data/configs/fish-basic.fish',
  },
];
